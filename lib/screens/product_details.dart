  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          color: Color.fromARGB(255, 91, 156, 241),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  InfoBox(title: 'C/Calories', content: widget.product?.calories?.toString() ?? 'N/A'),
                  InfoBox(title: 'C/Vitamins', content: widget.product?.vitamins?.toString() ?? 'N/A'),
                  InfoBox(title: 'C/Additives', content: widget.product?.additives?.toString() ?? 'N/A'),
                ],
              ),
              SizedBox(height: 16.0),
              Container(
