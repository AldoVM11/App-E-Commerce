...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('E-Commerce Rigel'),
        actions: <Widget>[
          IconButton(
      ...
      drawer: Drawer(
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              title: const Text('Add Products 🌭' , textAlign: TextAlign.center,),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                  context,
            ...
            ListTile(
              title: const Text('Add Categories 🍆', textAlign: TextAlign.center,),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                  context,
